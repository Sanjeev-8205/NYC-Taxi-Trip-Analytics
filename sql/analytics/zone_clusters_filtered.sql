--zone_clusters_filtered.sql
--Purpose: To cluster the zones based on the demand, efficiency and congestion.
--Grain: 1 row unique pickup_zone_name
--Source: mart.fct_zone_efficiency
--Note: This query filters out the Non-Actionable cluster from the results making it clean and consistent.
...
SELECT * FROM final WHERE clusters!='Non-Actionable'
